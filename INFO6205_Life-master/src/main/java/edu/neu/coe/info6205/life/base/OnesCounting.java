...
public class OnesCounting {
    ...
    private static Integer count(final Genotype<BitGene> gt) { return gt.getChromosome()
    ...
    public static void main( String [ ] args ) {
        ...
        final Engine<BitGene , Integer> engine = Engine . builder(
        OnesCounting :: count , BitChromosome . of (20 , 0.15) )
        . populationSize (500)
        . selector (new RouletteWheelSelector <>())
        .alterers(
        new Mutator<>(0.55),
        new SinglePointCrossover <>(0.06)) . build () ;
