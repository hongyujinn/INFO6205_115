...
public class Game implements Generational<Game, Grid>, Countable, Renderable {
		 ...
		 */
		public static long playGame(String turnMatrixToString) {
...
//			    final String pattern = stringPattern;
				final Behavior generations = run(0, turnMatrixToString);
		 ...
		 */
		public static Behavior run(long generation, String turnMatrixToString) {
				return run(generation, Point.points(turnMatrixToString));
		}
